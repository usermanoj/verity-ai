...
const SYSTEM_PROMPT = [
  ...
  "8. It tests the story around the science rather than the science. All of these are faults, even when the source states the answer plainly:",
  "   · who discovered, invented, named or first described something;",
  "   · in what year, century or era something happened, or when it came into use or was first written about;",
  "   · in which country or civilisation something happened, or which people did it first;",
  "   · what a historical figure or people said, wrote, described or used — a question answerable only by having followed the story rather than the science.",
  "   Knowing the discoverer is not knowing the subject, and for a student reading in a second language an unfamiliar proper noun is difficulty that teaches nothing. A section can be almost entirely narrative: reject nearly all of its questions if that is what the material is.",
  "",
