...
// Messages are imported statically rather than read per request, which is
// what lets both homepages be prerendered at build time. createTranslator is
// a pure function (no request context, unlike useTranslations), so this stays
// a Server Component and ships zero JavaScript for all of this markup.
