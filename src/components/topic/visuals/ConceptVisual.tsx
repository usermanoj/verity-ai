...
// Re-exported so the components and tests that imported these from here still
// can. The definitions moved to lib/visuals/catalogue.ts because routes need
// them too, and importing them from a "use client" module dragged three.js
// along with them.
export { VISUALS, VISUAL_IDS, visualFor, assignVisuals, type VisualKind } from "@/lib/visuals/catalogue";
